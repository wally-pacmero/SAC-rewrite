...
class Main extends PluginBase
{
  ...
  public function onEnable() : void
  {
    ...
    $this->getLogger()->info("[SAC] > ShadowAntiCheat enabled");
    ...
    {
      $this->getLogger()->warning(TextFormat::YELLOW . "[SAC] > Your configuration is outdated, please update when possible"); #nofify user about outdated config
    }
    ...
    {
      $this->getLogger()->error(TextFormat::RED . "[SAC] > Your configuration file is incompatible with this version of SAC, please delete ./plugin_data/ShadowAntiCheat/config.yml and ./plugin_data/ShadowAntiCheat/advanced.yml"); #throw error and nofify user about incompatible config
